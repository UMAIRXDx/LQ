...
for xd in range(10000):
	...
	f='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45'
	...
	l='Chrome/60.0.3112.116 Safari/537.36'
	uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Windows Phone 10.0; Android 4.2.1;'
	...
	i='Microsoft; Lumia 950)'
	j=random.randrange(1, 9)
	k=random.randrange(1, 9)
	l='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2486.0 Mobile Safari/537.36 Edge/13.1058'
